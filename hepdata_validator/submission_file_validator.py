...
from hepdata.modules.hepdata_records.validator import Validator, ValidationMessage
...
class SubmissionFileValidator(Validator):
    ...
    def validate(self, file_path):
        try:
            submission_file_schema = json.load(open(self.schema_file, 'r'))
            additional_file_section_schema = json.load(open(self.additonal_info_schema, 'r'))
